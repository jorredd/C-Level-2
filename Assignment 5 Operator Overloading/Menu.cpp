...
void Menu::runMenu()
{
	for (;;)
	{
		...
		for (int i = 0; i < count; i++)
		{
			...
			if (i == 7) cout << endl << "Fractions Functions" << endl; // I couldnt stand the way it was formatted so i added this code to format it better	
			if (i == 9) cout << endl; // I couldnt stand the way it was formatted so i added this code to format it better	
		}
		runSelection();
	}
}
